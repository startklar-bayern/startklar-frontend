...
const Sharepics = ({sharepics}) => {
    return (
        <div>
            ...
            <p className="text-light text-center">Lorem Ipsum dolor sit amet et consetutor, sadipscing elitr, sed diam
                nonumy eirmod empor ividunt ut labore et dolore magna aliquyam.</p>
            <Row className="mb-4">
                {sharepics.map((sharepic) => (
                    <Col xs={6} lg={3} key={'sharepic-' + sharepic.id}>
                        <img src={sharepic.imagePreviewUrl} alt={sharepic.altText} width="200" height="200"/>
                        <ShareButton
