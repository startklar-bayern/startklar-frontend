...
const Sharepics = ({sharepics}) => {
    return (
        <div>
            ...
            <p class="text-light text-center">Lorem Ipsum dolor sit amet et consetutor, sadipscing elitr, sed diam nonumy eirmod empor ividunt ut labore et dolore magna aliquyam.</p>
            <Row className="mb-4">
            ...
            <h6 class="follow-us text-center">Folge uns Auf: <a href="https://www.instagram.com" rel="noreferrer" target="_blank"><FontAwesomeIcon icon={faInstagram} /></a><a rel="noreferrer" href="https://www.facebook.com" target="_blank"><FontAwesomeIcon icon={faFacebook} /></a></h6>
        </div>
    )
};
