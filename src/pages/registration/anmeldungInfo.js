            ...
            <Container>
              ...
              <Row className="anmeldung-info-row">
                <Col>
                  ...
                  <p>Diese Person ist für die Gruppe verantwortlich und meldet euch gesammelt über die STARTKLAR Website an.<br/>Außerdem kümmert er*sie sich auch um die Einhaltung des Schutzkonzepts, nimmt an der Einweisung dazu teil und ist Ansprechpartner*in für Rückfragen.<br/>Die Gruppenleitung muss mindestens 18 Jahre alt sein.</p>
                  ...
                  <p>
                    Hier kannst du einen Anmeldebogen für deine Teilnehmer*innen als Vorlage herunterladen.<br/>
                  ...
                  {/*TODO: Link*/}
                  <a href="" target="_blank" className="btn-primary btn-sm"><FontAwesomeIcon icon="download" /> Anmeldebogen</a>
                  ...
                  <p>
                    {/*TODO: Link*/}
                    Weitere Infos dazu findest du auch in unserem <a href="" target="_blank">Schutzkonzept</a>.
                  </p>
